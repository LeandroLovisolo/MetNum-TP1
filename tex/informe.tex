...
El método de bisección es un método seguro para encontrar raices ya que nos asegura convergencia, pero es una convergencia del orden lineal\footnote{Demostración: Teorema 2.1 Numerical Analysis - Richard L. Burden, John Douglas Faires}.
...
tolerado elegimos los valores 0.1, 0.01 y 0.001 ya que una tolerancia de 0.1 podría mostrar diferencias significativas entre 0.01 y 0.001. Por último, decidimos probar con diferentes cantidades de bits de precisión en la mantisa, elegimos 51,30,10, para poder tener un valor de alta presición, media y baja con el cuál experimentar.

Al experimentar con las mantisas de 51, 30 y 10 bits vimos que el método de Newton divergía en todas las muestras con 10 bits y que bisección daba valores erroneos para la misma cantidad de bits. También 30 bits no mostraba diferencias significativas, decidimos volver a realizar los experimentos con 51 bits para tener un valor alto de precisión, 20 bits ya que alrededor de los 20 bits comienza a notarse una diferencia en la aproximación de los parámetros y 15 bits ya que buscamos el mínimo tamaño de mantisa tal que todas las muestras convergen a algun cero.
...
\graficodoble{referencia-1.tex}{Muestra X1}{referencia-2.tex}{Muestra X2}
\graficodoble{referencia-3.tex}{Muestra X3}{referencia-4.tex}{Muestra X4}
\graficodoble{referencia-5.tex}{Muestra X5}{referencia-6.tex}{Muestra X6}
...
\graficodoble{biseccion-mantisas.tex}{Muestra X1: Método de Bisección}
             {newton-mantisas.tex}{Muestra X1: Método de Newton}
             
\subsubsection{Distintos criterios de parada}

\graficodoble{biseccion-criterios-parada.tex}{Muestra X2: Método de Bisección}
             {newton-criterios-parada.tex}{Muestra X2: Método de Newton}
