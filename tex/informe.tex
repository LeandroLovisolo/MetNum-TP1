...
\graficodoble{biseccion-mantisas.tex}{Biseccion varias mantisas}
             {newton-mantisas.tex}{Newton con varias mantisas}
\graficodoble{biseccion-criterios-parada.tex}{Biseccion varios criterios de parada}
             {newton-criterios-parada.tex}{Newton varios criterios de parada}
