...
\incluircsv{biseccion.csv}
           {|c|c|c|c|c|c|c|c|}
           {Muestra & $\sigma$ & $\beta$ & $\lambda$ & Iteraciones & Criterio de parada & Cota de error & Bits de mantisa}
           {\nombremuestra{\Muestra} & \Sigma & \Beta & \Lambda & \Iteraciones & \CritParada & \CotaError & \BitsMantisa}
